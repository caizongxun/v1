...
print(f"\n  Sample Extrema Points:")
for i, ext in enumerate(extrema[:5]):
...
print("\nNext Steps:")
print("  1. Accuracy should be significantly higher (from 20% → 65-75%)")
print("  2. Feature importance now makes sense")
